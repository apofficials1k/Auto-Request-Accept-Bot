...
pr0fess0r_99=Client(
    ...
    bot_token = os.environ["6654040372:AAFKq29o0lChuii9cnRzTs7g9QsV63OlkaM"],
    api_id = int(os.environ["23007799"]),
    api_hash = os.environ["aa694ed52dbd072d6384053560132057"]
)

CHAT_ID=int(os.environ.get("-1001519095564", None))
